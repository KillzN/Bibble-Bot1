...
import {tiktokdl} from '@ineffable.mvrco';
...
import('@xct007/frieren-scraper')
  ...
  .catch((error) => {
    console.error('SIGUEME AL INSTAGRAM @ineffable.mvrco".');
  });
...
const handler = async (m, {conn, text, args, usedPrefix, command}) => {
  ...
  try {
    ...
    const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: texto, contextInfo: {externalAdReply: {title: 'ᴛʜᴇ ᴍʏsᴛɪᴄ - ʙᴏᴛ', body: null, thumbnail: imagen1, sourceUrl: 'https://github.com/KillzN/Bibble-Bot1'}, mentionedJid: [m.sender]}}}, aa);
