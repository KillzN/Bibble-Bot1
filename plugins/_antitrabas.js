/**
𝐁𝐈𝐁𝐁𝐋𝐄 𝐁𝐎𝐓 @ineffable.mvrco - _antitrabas.js
...
export async function before(m, { conn, isAdmin, isBotAdmin, usedPrefix }) {
  ...
  const fakemek = { 'key': { 'participant': '0@s.whatsapp.net', 'remoteJid': '0@s.whatsapp.net' }, 'message': { 'groupInviteMessage': { 'groupJid': '56944735533-1616969743@g.us', 'inviteCode': 'm', 'groupName': 'P', 'caption': '𝐁𝐈𝐁𝐁𝐋𝐄 𝐁𝐎𝐓', 'jpegThumbnail': null } } };
